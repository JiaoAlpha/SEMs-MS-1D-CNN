...
def evaluate(init_learning_rate=0.1, n_epochs=200,
                    ...
                    trans='euc', active_func=T.tanh, window_size = 0.12,
    ...
    ma_base,ma_step,ma_num   = 1, 1, 4
    ds_base, ds_step, ds_num = 4, 1, 4


    ds_num_max = length_train / (pool_factor * window_size)
    ds_num = max(ds_num, ds_num_max)
    
    #*******set up the ma and ds********#

    (ma_train, ma_valid, ma_test , ma_lengths) = batch_downsample(train_set_x,
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iteration + 1) % validation_frequency == 0:
                ...
                if valid_loss <= best_validation_loss:
                    ...
                    path = 'D:/TestResult/test_label'
                    sio.savemat(path, {'y_pred': y_pred, 'label': label})
