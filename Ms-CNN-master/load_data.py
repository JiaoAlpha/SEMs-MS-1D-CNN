...
database_path = './'
def load_data(dirname, normalization = True, slice_ratio = 1, idx_valid = 0):
    ...
    SEMfile1 = r"D:\Ms-CNN-master\Trace\Train_x.mat"
    data_x = sio.loadmat(SEMfile1)
    train_x = data_x['Train_x']

    SEMfile1 = r"D:\Ms-CNN-master\Trace\Train_y.mat"
    data_y = sio.loadmat(SEMfile1)
    train_y = data_y['Train_y']
    train_y = train_y.reshape((3400,))
    ...
    if len_data > 500:
       #  slice_ratio = slice_ratio if slice_ratio > 0.98 else 0.98
        slice_ratio = slice_ratio if slice_ratio > 1 else 1
    ...
    SEMfile1=r"D:\Ms-CNN-master\Trace\Test_x.mat"
    data_x=sio.loadmat(SEMfile1)
    test_x=data_x['Test_x']

    SEMfile1=r"D:\Ms-CNN-master\Trace\Test_y.mat"
    data_y=sio.loadmat(SEMfile1)
    test_y=data_y['Test_y']
    test_y=test_y.reshape((1456,))
